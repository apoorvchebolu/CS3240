...
public class Driver {
	...
	public static void main(String[] args) {
		// Responsible for creating the MainControl object as well as creating
		// and starting the threads for the BluetoothListener and the GUI
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				BluetoothListener mainListener = new BluetoothListener(
						mainControl, controlPanel);
